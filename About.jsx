    ...
    <>
      <div className="about center">
        <h1 data-aos="fade-right" className="mobileHead">
          Hello, I am <span className="about__name">Prithwish Nandy</span>
        </h1>
        <Type />
        ...
        <div className="about__contact center">
          <a
            href="https://https://github.com/PrithwishNandy"
            aria-label="github"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="mailto:prithwishn64@gmail.com"
            target="_blank"
            rel="noreferrer"
            aria-label="mail"
            className="link link--icon"
